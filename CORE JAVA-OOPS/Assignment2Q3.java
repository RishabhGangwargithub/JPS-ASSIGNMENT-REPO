  ...
  class CurrentAccount extends Assignment2Q3 
  {
	...
	public  class Assignment2Q3
	{
	    ...
	    public static void main(String[] args) 
	    {
	        ...
	        totalCashInBank.add(acc1.deposit(300));
	        totalCashInBank.add(acc2.deposit(5000));
	        totalCashInBank.add(acc3.deposit(600));
	        totalCashInBank.add(acc4.deposit(500));
	        totalCashInBank.add(acc3.withdraw(600));
	        totalCashInBank.add(acc2.withdraw(5300));
