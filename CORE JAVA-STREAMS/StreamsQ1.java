...
public class StreamsQ1 {
    ...
    public static void main(String[] args) {
        ...
        fruits.add( new Fruit("WATERMELON",70,50,"Yellow"));
        fruits.add(new Fruit("LICHI",80,80,"Red"));
        fruits.add(new Fruit("APPLE",110,40,"Yellow"));
        fruits.add( new Fruit("MANGO",100,30,"Yellow"));
        fruits.add(new Fruit("CHIKU",60,50,"Green"));
        reverseSort( fruits);
        sort(fruits);
