...
public class StreamsQ4 {
    ...
    public static void main(String[] args) {
        Trader t1 = new Trader("Manu ", "Bangalore");
        Trader t2 = new Trader("Jenny ", "Pune");
        Trader t3 = new Trader("Alexa ", "Bangalore");
        Trader t4 = new Trader("Ruby ", "Delhi");
        Trader t5= new Trader("Tarzan ", "Chennai");

        Trader t6 = new Trader("Lucky ", "Pune");
        Trader t7 = new Trader("Happy ", "Delhi");
        Trader t8 = new Trader("Gamora ", "Delhi");
        Trader t9 = new Trader("Penny ", "Pune");
