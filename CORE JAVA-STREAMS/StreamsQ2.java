...
public class StreamsQ2 {
    ...
    public static void main(String[] args) {
        News news1 = new News(1, "RG", "GANGWAR", "comment");
        News news2 =new News(2, "RISHABH", "GANGWARS", "budget");
        News news3 = new News(1, "NEHA", "BHATT", "comment");
        News news4 = new News(3, "SARTHAK", "AHLOWALIA", "budget");
        News news5 = new News(1, "SPANDHAN", "SHARMA", "comment");
        News news6 = new News(3, "SWAGAT", "CHAWLA", "budget");
        News news7 = new News(1, "RISHABH 2", "SHARMA" ,"comment");
